...
class ReportLocation(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        try:
            ...
            cityLatitude, cityLongitude, cityName, countryCode = reversePlace.reverse_place(currentCityId)
            nearCities = get_locations_nearby_coords(cityLatitude, cityLongitude, 3000)[:20]
        ...
        if profile.is_auto_location_report is True:
            try:
                latest = notification_models.MoveNotification.objects.filter(actor=user).latest('start_date', 'created_at')
                if latest.city != city:
        ...
        if payload == "PHOTO":
            if targetLocationType == "city":
                ...
                attachments = [{
                    ...
                    "title_link": "https://www.pinner.fun/city/%s" % (city.city_id),
                ...
                attachments = [{
                    ...
                    "title_link": "https://www.pinner.fun/country/%s" % (country.country_code),
                ...
                attachments = [{
                    ...
                    "title_link": "https://www.pinner.fun/continent/%s" % (continent.continent_code),
